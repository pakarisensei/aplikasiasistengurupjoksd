document.addEventListener('DOMContentLoaded', () => {
    // Memastikan ikon Lucide di-render
    lucide.createIcons();
    
    // --- DATABASE PJOK (INTI APLIKASI) ---
    const capaianPerElemen = {
        'Terampil Bergerak': {
            A: "Mempraktikkan keterampilan gerak fundamental dan menerapkannya dalam berbagai situasi gerak yang berbeda; mengeksplorasi berbagai strategi gerak; dan mengeksplorasi berbagai konsep gerak serta menyimpulkan efektivitasnya.",
            B: "Menghaluskan keterampilan gerak fundamental dan menerapkannya dalam situasi gerak yang baru; menyesuaikan strategi gerak untuk mendapatkan capaian keterampilan gerak; dan memperagakan berbagai konsep gerak yang dapat diterapkan dalam rangkaian gerak.",
            C: "Menyesuaikan keterampilan gerak melintasi berbagai situasi gerak; mentransfer strategi gerak yang sudah dikuasai ke dalam berbagai situasi gerak yang berbeda; dan menginvestigasi berbagai konsep gerak yang dapat diterapkan untuk meningkatkan capaian keterampilan gerak."
        },
        'Belajar melalui Gerak': {
            A: "Menaati peraturan untuk menumbuhkan fair play di dalam berbagai aktivitas jasmani; menerapkan strategi kolaborasi ketika berpartisipasi dalam aktivitas jasmani.",
            B: "Menerapkan strategi gerak sederhana dan memecahkan masalah gerak; menerapkan peraturan untuk menumbuhkan fair play di dalam berbagai aktivitas jasmani; dan berpartisipasi secara positif dalam kelompok atau tim di dalam berbagai aktivitas jasmani.",
            C: "Menguji efektivitas penerapan strategi gerak dalam berbagai situasi gerak; merancang peraturan alternatif dan modifikasi permainan untuk mendukung fair play dan partisipasi inklusif; dan menjalankan berbagai peran untuk mencapai keberhasilan kelompok atau tim di dalam berbagai aktivitas jasmani."
        },
        'Bergaya Hidup Aktif': {
            A: "Berpartisipasi di dalam berbagai aktivitas jasmani dan mengidentifikasi manfaatnya.",
            B: "Berpartisipasi dalam berbagai aktivitas jasmani dan mengenali faktor-faktor yang menyebabkan aktivitas jasmani menyenangkan.",
            C: "Berpartisipasi dalam aktivitas jasmani dan menjelaskan pengaruh aktivitas jasmani yang teratur terhadap kesehatan; mengidentifikasi rekomendasi aktivitas jasmani serta pencegahan perilaku sedenter."
        },
        'Memilih Hidup yang Menyehatkan': {
            A: "Mengenali gaya hidup aktif dan sehat; mengenali manfaat komponen makanan bergizi seimbang; serta mengenali situasi dan potensi yang berisiko terhadap kesehatan dan keselamatan serta strategi mencari bantuan kepada orang dewasa terpercaya.",
            B: "Mengenali risiko kesehatan akibat gaya hidup dan berbagai aktivitas jasmani untuk pencegahannya; mengidentifikasi pola makan sehat dan bergizi seimbang sesuai rekomendasi kesehatan untuk menunjang aktivitas sehari-hari; dan mempraktikkan penanganan cedera ringan sesuai pemahaman tentang prinsip pertolongan pertama.",
            C: "Mengidentifikasi dan menghubungkan antara gaya hidup, risiko kesehatan, dan aktivitas pencegahannya sesuai rekomendasi otoritas kesehatan; menjelaskan pola makan sehat untuk menunjang aktivitas jasmani berdasarkan informasi kandungan gizi pada makanan; dan mempraktikkan penanganan cedera sedang sesuai pemahaman tentang prinsip pertolongan pertama."
        }
    };
    ...
    const sintaksDatabaseV2 = {
        ...
        spesifik: {
            'lokomotor-1': {
                'Project-Based Learning (PjBL)': [ { phase: 'Pertanyaan Mendasar', activity: 'Guru memantik ide siswa dengan pertanyaan: "Bagaimana kita bisa membuat permainan baru yang seru hanya dengan berjalan dan berlari?"', experience: 'memahami' }, { phase: 'Merancang Proyek', activity: 'Dalam kelompok kecil, siswa berdiskusi dan menggambar rancangan permainan mereka: nama permainan, aturan sederhana, dan area bermainnya.', experience: 'mengaplikasi' }, { phase: 'Membuat Jadwal & Latihan', activity: 'Guru membantu membuat jadwal sederhana. Siswa berlatih teknik berjalan dan berlari yang benar sebagai persiapan.', experience: 'mengaplikasi' }, { phase: 'Menguji Hasil (Bermain!)', activity: 'Setiap kelompok mempraktikkan permainan ciptaan mereka di lapangan. Kelompok lain memberi tepuk tangan.', experience: 'mengaplikasi' }, { phase: 'Refleksi Pengalaman', activity: 'Siswa menceritakan bagian mana dari permainan yang paling mereka sukai dan apa yang mereka pelajari tentang berjalan dan berlari.', experience: 'merefleksi' } ],
                'Sport Education Model (SEM)': [ { phase: 'Pengenalan Musim', activity: 'Guru mengumumkan dimulainya "Mini Olimpiade Gerak" yang akan berlangsung selama beberapa pertemuan.', experience: 'memahami' }, { phase: 'Pembentukan Tim', activity: 'Siswa dibagi dalam tim tetap (misal: Tim Elang, Tim Kancil). Setiap tim membuat yel-yel penyemangat.', experience: 'mengaplikasi' }, { phase: 'Sesi Latihan', activity: 'Tim berlatih bersama dalam berbagai permainan: estafet lari lurus, berjalan cepat, dan berlari zig-zag melewati rintangan (cone).', experience: 'mengaplikasi' }, { phase: 'Pertandingan Mini', activity: 'Tim saling bertanding dalam lomba estafet dan halang rintang. Ada siswa yang bertugas jadi "penyemangat" dan "pencatat garis finis".', experience: 'mengaplikasi' }, { phase: 'Festival & Selebrasi', activity: 'Di akhir musim, semua tim merayakan dengan "Festival Gerak" dan guru memberikan penghargaan simbolik seperti medali kertas atau stiker bintang.', experience: 'merefleksi' } ]
            }
        }
    };
    ...
    function getStyledLabel(type, text) {
        ...
        const styles = {
            'joyful': 'background-color: #fef9c3; color: #713f12;',
            'meaningful': 'background-color: #dcfce7; color: #14532d;',
            'mindful': 'background-color: #e0e7ff; color: #312e81;',
            'memahami': 'background-color: #cffafe; color: #155e75; border-color: #0e7490;',
            'mengaplikasi': 'background-color: #dcfce7; color: #166534; border-color: #16a34a;',
            'merefleksi': 'background-color: #ede9fe; color: #4c1d95; border-color: #5b21b6;',
        };
    ...
    function buildKerangkaPembelajaran(d) {
        ...
        return `<h3 class="subsection-title">1. Kerangka Pembelajaran Mendalam</h3><p>Agar pembelajaran berjalan efektif, kerangka pembelajaran ini mencakup empat komponen utama:</p><ol>
            ...
            <li><strong>Pemanfaatan Teknologi Digital:</strong> ${teknologiDesc}</li></ol>`;
    }
    ...
    function buildLangkahPembelajaran(d) {
        ...
        if(includeCoding && codingTime > 0 && codingTime < durasiIntiAwal) { durasiIntiAwal -= codingTime; }
        const durasi = { pendahuluan: Math.round(totalMenitPerPertemuan * 0.15), penutup: Math.round(totalMenitPerPertemuan * 0.15), inti: durasiIntiAwal };
        ...
        for (let i = 0; i < alokasiWaktu.jumlahPertemuan; i++) {
            ...
            kegiatanHTML += `<p><strong>Kegiatan Pendahuluan (${durasi.pendahuluan} Menit):</strong></p><ol>
                ...
                <li>Pemanasan dengan permainan yang relevan untuk mempersiapkan fisik dan mental. ${getLearningLabel("permainan")}</li></ol>`;
            kegiatanHTML += `<p><strong>Kegiatan Inti (${durasi.inti} Menit):</strong></p>`;
            ...
            modelSintaks.forEach(step => {
                if (step.isEnrichment) {
                    ...
                    const activityText = step.activity.replace(/{materi_spesifik}/g, `<strong>${placeholderMateri}</strong>`);
                    kegiatanHTML += `<tr>
                        ...
                        <td style="border: 1px solid #d1d5db; padding: 0.75rem; vertical-align: top;">${getPengalamanLabel(step.experience)}</td></tr>`;
                }
            });
            ...
            kegiatanHTML += `<p><strong>Kegiatan Penutup (${durasi.penutup} Menit):</strong></p><ol>
                ...
                <li>Guru menutup pelajaran dengan doa dan menyampaikan gambaran pertemuan berikutnya.</li></ol>`;
    ...
    function buildPengayaanRemedial(d) {
        ...
        const pengayaanText = `Siswa yang sudah mahir diminta untuk mencoba variasi gerakan ${placeholderMateri.toLowerCase()} yang lebih sulit (misal: dengan rintangan, tempo lebih cepat, atau dikombinasikan dengan gerakan lain) dan menunjukkannya kepada teman-teman.`;
    ...
    function buildRefleksi(d) {
        return `<h5><strong>Refleksi Guru</strong></h5><ul>
        ...
        </ul><h5 class="mt-6"><strong>Refleksi Peserta Didik</strong></h5><ul>
            <li>Pada bagian mana dari pelajaran hari ini yang kamu rasa paling seru?</li>
            <li>Apa kesulitan terbesar yang kamu temui saat mencoba gerakan tadi?</li>
            <li>Apa yang akan kamu lakukan agar bisa lebih baik lagi pada pertemuan berikutnya?</li></ul>`;
    }
    
    function buildLkpd(d) {
        const placeholderMateri = d.materiSpesifik || d.materiJudul.replace(/Aktivitas.*?:\s*/, '').trim();
        return `<h3>1. Lembar Kerja Peserta Didik (LKPD)</h3><div class="lampiran-box">
            <p><strong>Topik Kegiatan:</strong> Praktik ${placeholderMateri}</p>
            <p><strong>Tujuan:</strong> Siswa dapat mempraktikkan ${placeholderMateri.toLowerCase()} sesuai dengan contoh dan instruksi dari guru.</p><hr class="my-2">
            <h5><strong>A. Petunjuk & Langkah Kerja</strong></h5><ol>
                <li>Bekerjalah sesuai arahan guru dan sintaks model pembelajaran <strong>${d.modelPembelajaran}</strong>.</li>
                <li>Perhatikan demonstrasi dari guru dengan saksama.</li>
                <li>Lakukan latihan secara individu, berpasangan, atau berkelompok.</li>
                <li>Jangan takut bertanya jika ada kesulitan.</li></ol>
            <hr class="my-2"><h5><strong>B. Pertanyaan Refleksi Diri</strong></h5><ul><li>Bagian tubuh mana yang harus paling diperhatikan saat melakukan gerakan ini?</li><li>Apa perbedaan yang kamu rasakan saat melakukan gerakan dengan benar dan salah?</li></ul></div>`;
    }
    ...
    function buildAsesmenOtentik(d) {
        ...
        let rubrikHTML = `<h3>2. Format Penilaian Otentik (Sumatif)</h3><div class="lampiran-box">
            <p><strong>Bentuk Asesmen:</strong> Unjuk Kerja: Praktik Keterampilan ${placeholderMateri}</p>
            <h5 style="margin-top:1.5rem;"><strong>Rubrik Penilaian Keterampilan:</strong></h5>
            <table style="font-size:0.85em;"><thead><tr><th>Kriteria</th><th>Skor 4 (Sangat Baik)</th><th>Skor 3 (Baik)</th><th>Skor 2 (Cukup)</th><th>Skor 1 (Perlu Bimbingan)</th></tr></thead><tbody>`;
        criteria.forEach(c => {
            rubrikHTML += `<tr><td><strong>${c.name}</strong><br><small>${c.desc}</small></td>
                ...
                <td>Memerlukan bimbingan intensif pada hampir semua aspek.</td></tr>`;
        });
    ...
    function buildCodingPJOKLampiran(d) {
        ...
        if(d.includeCoding) {
            content = `<p class="font-semibold text-gray-700">Petunjuk:</p>
                ...
                <div class="mt-4 p-4 border-2 border-dashed rounded-md bg-gray-50 text-center text-gray-500">[ Tempelkan hasil dari 'Ide Coding PJOK' di sini ]</div>`;
        }
    ...
    function buildDaftarPustaka(d) {
        ...
        return `<h3 class="subsection-title">2. Daftar Pustaka</h3><div class="lampiran-box"><ul>
            ...
            <li>YouTube Kids & Platform Video Edukasi lainnya.</li></ul></div>`;
    }
    ...
    async function callGemini(prompt, emoji = '🧠') {
        ...
        try {
            // Panggil Netlify Function, bukan API Google secara langsung
            ...
            return result.text; // Serverless function akan mengembalikan teks langsung

        } catch (error) {
            console.error("callGemini Error:", error);
            return `Terjadi kesalahan: ${error.message}. Mohon coba lagi. Pastikan Anda telah mengatur GEMINI_API_KEY di Netlify.`;
        }
    }
    ...
    function setupEventListeners() {
        ...
        ui.gemini.modalCopy.addEventListener('click', () => {
            ...
            const wordStyles = `<style>
                ...
                h1, h2, h3 { font-family: 'Poppins', Arial, sans-serif; font-weight: 700; margin-top: 1.25em; margin-bottom: 0.5em; color: #111827; }
            ...
            const fullHtmlForClipboard = `<!DOCTYPE html><html lang="id"><head><meta charset="UTF-8">
